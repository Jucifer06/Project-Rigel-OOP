...
class PolynomialTest {
    ...
    void toStringWorksOnKnownPolynomials() {
        ...
        var polynomial9 = Polynomial.of(-1, 0, 0, -6);
        assertEquals("-x^3-6.0", polynomial9.toString());
        var polynomial10 = Polynomial.of(-2, -6, -2, 0);
        assertEquals("-2.0x^3-6.0x^2-2.0x", polynomial10.toString());
    }
