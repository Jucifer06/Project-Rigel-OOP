...
public final class DrawSky extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        try (InputStream hs = resourceStream("/hygdata_v3.csv")) {
            try (InputStream asterismStream = getClass().getResourceAsStream("/asterisms.txt")) {
                ...
                painter.drawStars(sky, projection, planeToCanvas,Color.BLUE);
                painter.drawPlanet(sky, projection, planeToCanvas);
