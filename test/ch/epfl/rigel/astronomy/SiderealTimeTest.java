...
public class SiderealTimeTest {
    ...
    @Test
    void greenwich() {
        /** double T = (476.5 / 36525.0);
         double t = 14 + 36.0 / 60.0 + 51.0 / 3600.0;
         double sl = (0.000025862 * T * T + 2400.051336 * T + 6.697374558) + (1.002737909 * t);
         ZonedDateTime zone1 = ZonedDateTime.of(LocalDate.of(2001, Month.APRIL, 22), LocalTime.of(14, 36, 51), ZoneOffset.UTC);
         assertEquals(1.7457095883, SiderealTime.greenwich(zone1));
         */
        ZonedDateTime zone2 = ZonedDateTime.of(LocalDate.of(1980, Month.APRIL, 22), LocalTime.of(14, 36, 51, 670000000), ZoneOffset.UTC);
        assertEquals(1.2221108127288611, SiderealTime.greenwich(zone2), 0.0000001);
    }

    @Test
    void localTestSimple() {
        ZonedDateTime zone = ZonedDateTime.of(LocalDate.of(1980, Month.APRIL, 22), LocalTime.of(14, 36, 51, 670000000), ZoneOffset.UTC);
        GeographicCoordinates coord = GeographicCoordinates.ofDeg(-64, 0);
        double sl = SiderealTime.greenwich(zone) + coord.lon();
        sl = Angle.normalizePositive(sl);
        assertEquals(sl, SiderealTime.local(zone, coord));
    }
