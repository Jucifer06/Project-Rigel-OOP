...
public class EpochTest {
    ...
    @Test
    public void daysUntilSimple() {
        ZonedDateTime zone1 = ZonedDateTime.of(LocalDate.of(1999, Month.DECEMBER, 1), LocalTime.of(12, 0), ZoneOffset.UTC);
        assertEquals(-31, Epoch.J2000.daysUntil(zone1), 0.00000001);
    }

    @Test
    public void JulianCenturiesUntilSimple() {
        ZonedDateTime zone1 = ZonedDateTime.of(LocalDate.of(2001, Month.JANUARY, 1), LocalTime.of(12, 0), ZoneOffset.UTC);
        assertEquals(366.0 / 36525, Epoch.J2000.julianCenturiesUntil(zone1));
        ZonedDateTime zone2 = ZonedDateTime.of(LocalDate.of(2001, Month.JANUARY, 11), LocalTime.of(16, 03), ZoneOffset.UTC);
        assertEquals((366.0 + 10.0 + 16.0 / 24.0 + (3.0 / (24.0 * 60.0))) / 36525.0, Epoch.J2000.julianCenturiesUntil(zone2), 0.001);
